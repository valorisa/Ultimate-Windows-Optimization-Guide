...
# delete drs folder
Remove-Item -Path "$env:ProgramData\NVIDIA Corporation\Drs" -Recurse -Force -ErrorAction SilentlyContinue | Out-Null
# create new drs folder
New-Item -Path "$env:ProgramData\NVIDIA Corporation" -Name "Drs" -ItemType Directory -ErrorAction SilentlyContinue | Out-Null
